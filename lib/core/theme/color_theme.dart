...
class SimpleColorTheme extends ThemeExtension<SimpleColorTheme> {
  ...
  @override
  ThemeExtension<SimpleColorTheme> copyWith({
    Color? primary,
  ...
  @override
  ThemeExtension<SimpleColorTheme> lerp(
    covariant ThemeExtension<SimpleColorTheme>? other,
    double t,
  ) {
    if (other is! SimpleColorTheme) {
      return this;
    }
  ...
  /// Light color scheme
  static final SimpleColorTheme light = SimpleColorTheme(
    primary: SimpleColors.primary,
    primarySurface: SimpleColors.primarySurface,
    primaryFocus: SimpleColors.primaryFocus,
    primaryBorder: SimpleColors.primaryBorder,
    primaryHover: SimpleColors.primaryHover,
    primaryPressed: SimpleColors.primaryPressed,
    secondary: SimpleColors.secondary,
    secondarySurface: SimpleColors.secondarySurface,
    secondaryFocus: SimpleColors.secondaryFocus,
    secondaryBorder: SimpleColors.secondaryBorder,
    secondaryHover: SimpleColors.secondaryHover,
    secondaryPressed: SimpleColors.secondaryPressed,
    neutral10: SimpleColors.neutral[10],
    neutral20: SimpleColors.neutral[20],
    neutral30: SimpleColors.neutral[30],
    neutral40: SimpleColors.neutral[40],
    neutral50: SimpleColors.neutral[50],
    neutral60: SimpleColors.neutral[60],
    neutral70: SimpleColors.neutral[70],
    neutral80: SimpleColors.neutral[80],
    neutral90: SimpleColors.neutral[90],
    neutral100: SimpleColors.neutral[100],
    error: SimpleColors.error,
    errorSurface: SimpleColors.errorSurface,
    errorBorder: SimpleColors.errorBorder,
    errorHover: SimpleColors.errorHover,
    errorPressed: SimpleColors.errorPressed,
    success: SimpleColors.success,
    successSurface: SimpleColors.successSurface,
    successBorder: SimpleColors.successBorder,
    successHover: SimpleColors.successHover,
    successPressed: SimpleColors.successPressed,
    warning: SimpleColors.warning,
    warningSurface: SimpleColors.warningSurface,
    warningBorder: SimpleColors.warningBorder,
    warningHover: SimpleColors.warningHover,
    warningPressed: SimpleColors.warningPressed,
    info: SimpleColors.info,
    infoSurface: SimpleColors.infoSurface,
    infoBorder: SimpleColors.infoBorder,
    infoHover: SimpleColors.infoHover,
    infoPressed: SimpleColors.infoPressed,
  );

  /// Dark color scheme
  static final SimpleColorTheme dark = SimpleColorTheme(
    primary: SimpleColors.primary,
    primarySurface: SimpleColors.primarySurface,
    primaryFocus: SimpleColors.primaryFocus,
    primaryBorder: SimpleColors.primaryBorder,
  ...
  @override
  String toString() => 'SimpleColorTheme('
      'primary: $primary, '
